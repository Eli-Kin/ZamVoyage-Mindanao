...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Zamboanga_Town_Home_Bed_and_Breakfast : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_zamboanga_town_home_bed_and_breakfast);
            ...
            {
                Resource.Drawable.zamboanga_town_home_bed_and_breakfast_1,
                Resource.Drawable.zamboanga_town_home_bed_and_breakfast_2,
                Resource.Drawable.zamboanga_town_home_bed_and_breakfast_3,
                Resource.Drawable.zamboanga_town_home_bed_and_breakfast_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is conveniently located in the popular City Proper area."
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "zamboanga_town_home_bed_and_breakfast_1" && cm.Title == "Zamboanga Town Home Bed and Breakfast" && cm.Description == "It is conveniently located in the popular City Proper area.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ZTHBB").Get().AddOnSuccessListener(this);

            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("ZTHBBNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ZTHBB");
