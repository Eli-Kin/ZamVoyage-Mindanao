...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Lantaka_Hotel_by_the_Sea : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_lantaka_hotel_by_the_sea);
            ...
            {
                Resource.Drawable.lantaka_hotel_by_the_sea_1,
                Resource.Drawable.lantaka_hotel_by_the_sea_2,
                Resource.Drawable.lantaka_hotel_by_the_sea_3,
                Resource.Drawable.lantaka_hotel_by_the_sea_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is a beautiful hotel located in Valderosa Street, Zamboanga City. The hotel offers a variety of rooms, ranging from deluxe rooms to suites, with rates starting at around PHP 3,000 per night. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "lantaka_hotel_by_the_sea_1" && cm.Title == "Lantaka Hotel by the Sea" && cm.Description == "It is a beautiful hotel located in Valderosa Street, Zamboanga City. The hotel offers a variety of rooms, ranging from deluxe rooms to suites, with rates starting at around PHP 3,000 per night. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("LHS").Get().AddOnSuccessListener(this);

            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("LHSNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("LHS");
