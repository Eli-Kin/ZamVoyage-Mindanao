...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Zamboanga_Motor_Rental : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_zamboanga_motor_rental);
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "A company in Zamboanga City offer a range of motorcycles and scooters for rent, including small and large motorcycles, automatic and manual scooters, and dirt bikes."
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "motor_rental" && cm.Title == "Zamboanga Motor Rental"  && cm.Description == "A company in Zamboanga City offer a range of motorcycles and scooters for rent, including small and large motorcycles, automatic and manual scooters, and dirt bikes.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("MOTOR").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("MOTORNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("MOTOR");
