...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Lokot_Lokot : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_lokot_lokot);
            ...
            {
                Resource.Drawable.lokot_lokot_1,
                Resource.Drawable.lokot_lokot_2,
                Resource.Drawable.lokot_lokot_3,
                Resource.Drawable.lokot_lokot_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Lokot-Lokot",
                    Description = "A local delicacy found in Zamboanga city and other parts of Mindanao. It is called by the locals as “jaa”, “lokot-lokot”, “Zambo Rolls, or “tagktak”, depending on where you find the delicacy. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "lokot_lokot_1" && cm.Title == "Lokot-Lokot" && cm.Description == "A local delicacy found in Zamboanga city and other parts of Mindanao. It is called by the locals as “jaa”, “lokot-lokot”, “Zambo Rolls, or “tagktak”, depending on where you find the delicacy. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("LL").Get().AddOnSuccessListener(this);

            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("LLNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("LL");
