...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Satti : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_satti);
            ...
            {
                Resource.Drawable.satti_1,
                Resource.Drawable.satti_2,
                Resource.Drawable.satti_3,
                Resource.Drawable.satti_4,
            };
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "satti_1" && cm.Title == "Satti" && cm.Description == "This popular breakfast dish consists of grilled meat on a stick, usually chicken or beef, served with rice cakes and a spicy sauce made with chili, garlic, and vinegar.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ST").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("STNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ST");
