...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Yakan_Weaving_Center : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_yakan_weaving_center);
            ...
            {
                Resource.Drawable.yakan_weaving_center_1,
                Resource.Drawable.yakan_weaving_center_2,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is a cultural center located in Barangay Upper Calarian, Zamboanga City. The center is dedicated to preserving and promoting the traditional art of Yakan weaving. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "yakan_weaving_center_1" && cm.Title == "Yakan Weaving Center" && cm.Description == "It is a cultural center located in Barangay Upper Calarian, Zamboanga City. The center is dedicated to preserving and promoting the traditional art of Yakan weaving. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("YWC").Get().AddOnSuccessListener(this);

            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("YWCNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("YWC");
