...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Alavar_Seafood_Restaurant : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_alavar_seafood_restaurant);
            ...
            {
                Resource.Drawable.alvar_seafood_restaurant_1,
                Resource.Drawable.alvar_seafood_restaurant_2,
                Resource.Drawable.alvar_seafood_restaurant_3,
                Resource.Drawable.alvar_seafood_restaurant_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is a popular seafood restaurant located in the heart of Zamboanga City. The restaurant is known for its delicious seafood dishes, particularly its famous curacha dish."
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "alvar_seafood_restaurant_1" && cm.Title == "Alavar Seafood Restaurant " && cm.Description == "It is a popular seafood restaurant located in the heart of Zamboanga City. The restaurant is known for its delicious seafood dishes, particularly its famous curacha dish.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ASR").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("ASRNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("ASR");
