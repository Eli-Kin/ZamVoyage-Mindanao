...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Canelar_Barter_Trade_Center : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_canelar_barter_trade_center);
            ...
            {
                Resource.Drawable.canelar_barter_trade_center_1,
                Resource.Drawable.canelar_barter_trade_center_2,
                Resource.Drawable.canelar_barter_trade_center_3,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "Canelar Barter Trade Center is an Arts and Crafts Store located in Barangay Canelar, Zamboanga, Zamboanga Peninsula. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "canelar_barter_trade_center_1" && cm.Title == "Canelar Barter Trade Center" && cm.Description == "Canelar Barter Trade Center is an Arts and Crafts Store located in Barangay Canelar, Zamboanga, Zamboanga Peninsula. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("CBTC").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("CBTCNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("CBTC");
