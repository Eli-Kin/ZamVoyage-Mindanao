...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Brews_Almighty : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_brews_almighty);
            ...
            {
                Resource.Drawable.brews_almighty_1,
                Resource.Drawable.brews_almighty_2,
                Resource.Drawable.brews_almighty_3,
                Resource.Drawable.brews_almighty_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is a cozy cafe located in Zamboanga City. The cafe serves a variety of coffee drinks, such as espresso, latte, cappuccino, and cold brew. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "brews_almighty_1" && cm.Title == "Brews Almighty" && cm.Description == "It is a cozy cafe located in Zamboanga City. The cafe serves a variety of coffee drinks, such as espresso, latte, cappuccino, and cold brew. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("BA").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("BANonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("BA");
