...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Bay_Tal_Mal_Restaurant : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_bay_tal_mal_restaurant);
            ...
            {
                Resource.Drawable.bay_tal_mak_restaurant_1,
                Resource.Drawable.bay_tal_mak_restaurant_2,
                Resource.Drawable.bay_tal_mak_restaurant_3,
                Resource.Drawable.bay_tal_mak_restaurant_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is a Filipino restaurant located at Mayor Jaldon St, Canelar, Zamboanga City, Zamboanga Sibugay Province. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "bay_tal_mak_restaurant_1" && cm.Title == "Bay Tal Mal Restaurant" && cm.Description == "It is a Filipino restaurant located at Mayor Jaldon St, Canelar, Zamboanga City, Zamboanga Sibugay Province. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("BTMR").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("BTMRNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("BTMR");
