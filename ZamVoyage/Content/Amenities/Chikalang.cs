...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Chikalang : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_chikalang);
            ...
            {
                Resource.Drawable.chikalang_1,
                Resource.Drawable.chikalang_2,
                Resource.Drawable.chikalang_3,
                Resource.Drawable.chikalang_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Chikalang",
                    Description = "It is a snack food in bilao or packed in plastic usually sold by street vendors in Zamboanga city. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "chikalang_1" && cm.Title == "Chikalang" && cm.Description == "It is a snack food in bilao or packed in plastic usually sold by street vendors in Zamboanga city. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("CK").Get().AddOnSuccessListener(this);

            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("CKNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("CK");
