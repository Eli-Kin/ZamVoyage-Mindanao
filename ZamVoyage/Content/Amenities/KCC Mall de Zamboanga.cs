...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class KCC_Mall_de_Zamboanga : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_kcc_mall_de_zamboanga);
            ...
            {
                Resource.Drawable.kcc_mall_de_zamboanga_1,
                Resource.Drawable.kcc_mall_de_zamboanga_2,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "KCC Mall de Zamboanga is a large shopping mall located in Barangay Canelar, Zamboanga City."
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "kcc_mall_de_zamboanga_1" && cm.Title == "KCC Mall de Zamboanga" && cm.Description == "KCC Mall de Zamboanga is a large shopping mall located in Barangay Canelar, Zamboanga City.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("KMDZ").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("KMDZNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("KMDZ");
