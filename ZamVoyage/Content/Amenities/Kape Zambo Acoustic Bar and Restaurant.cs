...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Kape_Zambo_Acoustic_Bar_and_Restaurant : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_kape_zambo_acoustic_bar_and_restaurant);
            ...
            {
                Resource.Drawable.kape_zambo_acoustic_bar_and_restaurant_1,
                Resource.Drawable.kape_zambo_acoustic_bar_and_restaurant_2,
                Resource.Drawable.kape_zambo_acoustic_bar_and_restaurant_3,
                Resource.Drawable.kape_zambo_acoustic_bar_and_restaurant_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is an Asian restaurant located on Canelar St, Fronting Metrobank, Zamboanga City, Zamboanga Sibugay Province. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "kape_zambo_acoustic_bar_and_restaurant_1" && cm.Title == "Kape Zambo Acoustic Bar and Restaurant" && cm.Description == "It is an Asian restaurant located on Canelar St, Fronting Metrobank, Zamboanga City, Zamboanga Sibugay Province. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("KZABR").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("KZABRNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("KZABR");
