...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Holy_Smokes_Korean_Grill_and_Resto : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_holy_smokes_korean_grill_and_resto);
            ...
            {
                Resource.Drawable.holy_smokes_1,
                Resource.Drawable.holy_smokes_2,
                Resource.Drawable.holy_smokes_3,
                Resource.Drawable.holy_smokes_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Holy Smokes Korean Grill & Resto",
                    Description = "It is an Asian restaurant located at 166 Cabato Road, 2F Blue Gym Building, Zamboanga City, Zamboanga Sibugay Province. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "holy_smokes_1" && cm.Title == "Holy Smokes Korean Grill & Resto" && cm.Description == "It is an Asian restaurant located at 166 Cabato Road, 2F Blue Gym Building, Zamboanga City, Zamboanga Sibugay Province. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("HSKGR").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("HSKGRNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("HSKGR");
