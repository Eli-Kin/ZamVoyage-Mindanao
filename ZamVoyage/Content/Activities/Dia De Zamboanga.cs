...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Dia_De_Zamboanga : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_dia_de_zamboanga);
            ...
            {
                Resource.Drawable.dia_de_zamboanga_1,
                Resource.Drawable.dia_de_zamboanga_2,
                Resource.Drawable.dia_de_zamboanga_3,
                Resource.Drawable.dia_de_zamboanga_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Description = "It is the biggest festival in Zamboanga City and is celebrated annually on February 26. The festival is a celebration of the city's founding and its rich cultural heritage. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "dia_de_zamboanga_1" && cm.Title == "Dia De Zamboanga" && cm.Description == "It is the biggest festival in Zamboanga City and is celebrated annually on February 26. The festival is a celebration of the city's founding and its rich cultural heritage.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("DDZ").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("DDZNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("DDZ");
