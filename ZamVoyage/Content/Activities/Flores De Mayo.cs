...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Flores_De_Mayo : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_flores_de_mayo);
            ...
            {
                Resource.Drawable.flores_de_mayo_1,
                Resource.Drawable.flores_de_mayo_2,
                Resource.Drawable.flores_de_mayo_3,
                Resource.Drawable.flores_de_mayo_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Flores_De_Mayo",
                    Description = "“Flowers of May” is the direct translation of this festival’s Spanish name. It is a monthlong revelry that is held during May annually, and it is celebrated in honor of the Virgin Mary. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "flores_de_mayo_1" && cm.Title == "Flores De Mayo" && cm.Description == "“Flowers of May” is the direct translation of this festival’s Spanish name. It is a monthlong revelry that is held during May annually, and it is celebrated in honor of the Virgin Mary. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("FDM").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("FDMNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("FDM");
