...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class The_Regatta_De_Zamboanga : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_the_regatta_de_zamboanga);
            ...
            {
                Resource.Drawable.the_regatta_de_zamboanga_1,
                Resource.Drawable.the_regatta_de_zamboanga_2,
                Resource.Drawable.the_regatta_de_zamboanga_3,
                Resource.Drawable.the_regatta_de_zamboanga_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "The Regatta De Zamboanga",
                    Description = "A popular annual boat race that takes place in Zamboanga City,"
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "the_regatta_de_zamboanga_1" && cm.Title == "The Regatta De Zamboanga" && cm.Description == "A popular annual boat race that takes place in Zamboanga City, ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TRDZ").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("TRDZNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TRDZ");
