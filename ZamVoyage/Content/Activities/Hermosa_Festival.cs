...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Hermosa_Festival : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_hermosa_festival);
            ...
            {
                Resource.Drawable.the_hermosa_festival_1,
                Resource.Drawable.the_hermosa_festival_2,
                Resource.Drawable.the_hermosa_festival_3,
                Resource.Drawable.the_hermosa_festival_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Hermosa Festival",
                    Description = "One of the most popular cultural events in Zamboanga City. It is celebrated every October in honor of the city's patron saint, Nuestra Señora del Pilar. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "the_hermosa_festival_1" && cm.Title == "Hermosa Festival" && cm.Description == "One of the most popular cultural events in Zamboanga City. It is celebrated every October in honor of the city's patron saint, Nuestra Señora del Pilar. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("HF").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("HFNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("HF");
