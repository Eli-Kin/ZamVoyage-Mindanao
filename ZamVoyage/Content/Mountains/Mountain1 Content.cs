...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Mountain1_Content : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.content_mountain1);
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ImagePath = "image2",
                    Title = "Title 1",
                    Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ullamcorper nunc ac varius blandit."
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "image2" && cm.Title == "Title 1" && cm.Description == "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ullamcorper nunc ac varius blandit.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                ISharedPreferences prefs = GetSharedPreferences("LoggedInToggleState", FileCreationMode.Private);
            ...
            else
            {
                ...
                ISharedPreferences prefs = GetSharedPreferences("NonLoggedInToggleState", FileCreationMode.Private);
                ISharedPreferencesEditor editor = prefs.Edit();
                editor.PutBoolean("toggleState", isToggleOn);
                editor.Commit();
            }
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document(uniqueId);
        ...
        private void RemoveFromFavoritesFirestore()
        {
            try
            {
                ...
                ISharedPreferences prefs = PreferenceManager.GetDefaultSharedPreferences(this);
                string favoriteItemId = prefs.GetString("favoriteItemId", "");

                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document(favoriteItemId);
                document.Delete();
