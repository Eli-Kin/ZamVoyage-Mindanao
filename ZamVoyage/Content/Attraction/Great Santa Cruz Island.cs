...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Great_Santa_Cruz_Island : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_great_santa_cruz_island);
            ...
            //prgph1.PaintFlags |= Android.Graphics.PaintFlags.UnderlineText;
            //prgph2.PaintFlags |= Android.Graphics.PaintFlags.UnderlineText;
            ...
            {
                Resource.Drawable.great_santa_cruz_island_1,
                Resource.Drawable.great_santa_cruz_island_2,
                Resource.Drawable.great_santa_cruz_island_3,
                Resource.Drawable.great_santa_cruz_island_4,
            };
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "great_santa_cruz_island_1" && cm.Title == "Great Santa Cruz Island" && cm.Description == "Also known as “Pink Beach”, is a popular tourist destination located off the coast of Zamboanga City, Philippines.");
        ...
        private void OnToggleButtonClicked(object sender, EventArgs e)
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                if (isToggleOn)
                {
                    RemoveFromFavoritesFirestore(favoritesItem);
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("GSCI").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("GSCINonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("GSCI");
        ...
        private void RemoveFromFavoritesFirestore(FavoriteItem favoriteItem)
        {
            try
            {
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("GSCI");
