...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Once_Islas : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_once_islas);
            ...
            {
                Resource.Drawable.once_island_1,
                Resource.Drawable.once_island_2,
                Resource.Drawable.once_island_3,
                Resource.Drawable.once_island_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Once Islas",
                    Description = "A steadily rising tourist attraction is Once Islas (11 Islands), a string of islands and islets off the eastern coast of Zamboanga City. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "once_island_1" && cm.Title == "Once Islas" && cm.Description == "A steadily rising tourist attraction is Once Islas (11 Islands), a string of islands and islets off the eastern coast of Zamboanga City. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("OI").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("OINonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("OI");
