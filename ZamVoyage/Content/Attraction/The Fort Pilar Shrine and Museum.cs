...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class The_Fort_Pilar_Shrine_and_Museum : AppCompatActivity,
Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_the_fort_pilar_shrine_and_museum);
            ...
            {
                Resource.Drawable.the_fort_pilar_shrine_and_museum_1,
                Resource.Drawable.the_fort_pilar_shrine_and_museum_2,
                Resource.Drawable.the_fort_pilar_shrine_and_museum_3,
                Resource.Drawable.the_fort_pilar_shrine_and_museum_4,
            };
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "the_fort_pilar_shrine_and_museum_1" && cm.Title == "The Fort Pilar Shrine and Museum" && cm.Description == "It is a popular landmark in Zamboanga City that is steeped in history and culture.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TFPSM").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("TFPSMNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TFPSM");
