...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class Paseo_del_Mar : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_paseo_del_mar);
            ...
            {
                Resource.Drawable.paseo_del_mar_1,
                Resource.Drawable.paseo_del_mar_2,
                Resource.Drawable.paseo_del_mar_3,
                Resource.Drawable.paseo_del_mar_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "Paseo del Mar",
                    Description = "It is a waterfront park that offers a variety of activities and attractions for visitors of all ages. The park is open daily from 6 AM to 10 PM. "
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "paseo_del_mar_1" && cm.Title == "Paseo del Mar" && cm.Description == "It is a waterfront park that offers a variety of activities and attractions for visitors of all ages. The park is open daily from 6 AM to 10 PM. ");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("PDM").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("PDMNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("PDM");
