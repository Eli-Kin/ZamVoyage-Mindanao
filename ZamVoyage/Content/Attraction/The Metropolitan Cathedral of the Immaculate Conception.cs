...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class The_Metropolitan_Cathedral_of_the_Immaculate_Conception : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_the_metropolitan_cathedral_of_the_immaculate_conception);
            ...
            {
                Resource.Drawable.the_metropolitan_cathedral_of_the_immaculate_conception_1,
                Resource.Drawable.the_metropolitan_cathedral_of_the_immaculate_conception_2,
                Resource.Drawable.the_metropolitan_cathedral_of_the_immaculate_conception_3,
                Resource.Drawable.the_metropolitan_cathedral_of_the_immaculate_conception_4,
            };
            ...
            else
            {
                favoritesItem = new FavoriteItem
                {
                    ...
                    Title = "The Metropolitan Cathedral of the Immaculate Conception",
                    Description = "It is one of the oldest and most"
                };
            }
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "the_metropolitan_cathedral_of_the_immaculate_conception_1" && cm.Title == "The Metropolitan Cathedral of the Immaculate Conception" && cm.Description == "It is one of the oldest and most");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TMCIC").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("TMCICNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TMCIC");
        ...
        public void OnSuccess(Java.Lang.Object result)
        {
            ...
            if (snapshot.Exists())
            {
                FavoriteItem favoriteItem = new FavoriteItem
                {
                    ...
                    ImagePath = snapshot.GetString("Location"),
