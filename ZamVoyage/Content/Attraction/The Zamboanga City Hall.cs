...
namespace ZamVoyage.Content.Mountains
{
    ...
    public class The_Zamboanga_City_Hall : AppCompatActivity, Android.Gms.Tasks.IOnSuccessListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_the_zamboanga_city_hall);
            ...
            {
                Resource.Drawable.the_zamboanga_city_hall_1,
                Resource.Drawable.the_zamboanga_city_hall_2,
                Resource.Drawable.the_zamboanga_city_hall_3,
                Resource.Drawable.the_zamboanga_city_hall_4,
            };
        ...
        private int GetContentIdFromDatabase()
        {
            ...
            FavoriteItem favoriteContent = favoritesItems.FirstOrDefault(cm => cm.ImagePath == "the_zamboanga_city_hall_1" && cm.Title == "The Zamboanga City Hall" && cm.Description == "The center government of the city. It is located in the heart of the city and features a beautiful neoclassical architecture.");
        ...
        protected override void OnPause()
        {
            ...
            if (firebaseAuth.CurrentUser != null)
            {
                ...
                firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TZCH").Get().AddOnSuccessListener(this);
            }
            else
            {
                // No user is logged in, store the toggle state for non-logged-in user
                ISharedPreferences prefs = GetSharedPreferences("TZCHNonLoggedInToggleState", FileCreationMode.Private);
        ...
        private async void AddToFavoritesFirestore()
        {
            try
            {
                ...
                DocumentReference document = firestore.Collection("users").Document(firebaseAuth.CurrentUser.Uid).Collection("favorites").Document("TZCH");
